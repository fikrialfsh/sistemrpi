          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-11 col-12">
                <h6 class="h2 text-white d-inline-block mb-0">Edit Kategori Barang</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <div class="card-action">
                        <form role="form" method="post" action="{{ url('/kategori/update/'. $kategori->id) }}">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" name="kategori_name" class="form-control" placeholder="Nama Kategori Obat" value="{{$kategori->kategori_name}}" >
