...
<head>
  ...
  <title>Halaman Tambah Proker </title>
  <!-- Favicon -->
          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-11 col-12">
                <h6 class="h2 text-white d-inline-block mb-0">Tambah Proker</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <div class="card-action">
                         <form role="form" method="post" action="{{ url('/proker/tambahdata') }}" >
                            {{ csrf_field() }}
                         <div class="box-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                                 ...
                                 <input type="text" name="deskripsi_kegiatan" class="form-control" placeholder="deskripsi_kegiatan" >
