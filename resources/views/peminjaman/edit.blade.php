          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-11 col-12">
                <h6 class="h2 text-white d-inline-block mb-0">Edit Status</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <div class="card-action">
                        <form method="post" action="{{ url('/peminjaman/update/'. $peminjaman->id) }}" enctype="multipart/form-data">
                         ...
                         <div class="form-group">
                                 ...
                                 <input type="text" name="nama_kegiatan" class="form-control" placeholder="Nama Proker" value="{{$peminjaman->nama_kegiatan}}">
