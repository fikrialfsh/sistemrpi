...
<head>
  ...
  <title>Halaman Peminjaman Barang</title>
  <!-- Favicon -->
          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-11 col-12">
                <h6 class="h2 text-white d-inline-block mb-0">Form Peminjaman Barang</h6>
                ...
                <div class="card-action">
                  <a href="{{url('/peminjaman/tambah')}}" class="btn btn-success btn-sm"><i class="fa fa-plus p-r-5">  TAMBAH PEMINJAMAN</i></a>
                </div>
                <br>
                  ...
                  <table class="table table-light" id="datatables">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  <!-- <a href="/peminjaman/edit/{{ $pem->id }}"class="btn btn-success" ><i class="fa fa-edit"></i></a> -->
                                  <a href="/peminjaman/delete/{{ $pem->id }}"class="btn btn-danger"><i class="fa fa-trash"></i></a>
                              </td>
                          </tr>
