...
<head>
  ...
  <title>Halaman Edit Inventaris </title>
  <!-- Favicon -->
          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-11 col-12">
                <h6 class="h2 text-white d-inline-block mb-0">Edit Inventaris</h6>
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <div class="card-action">
                         <form role="form" method="post" action="{{ url('/inventaris/update/'.$inventaris->id) }}" >
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                         ...
                         <div class="form-group">
                                 ...
                                 <input type="text" name="nama_barang" class="form-control" placeholder="Nama Barang" value="{{$inventaris->nama_barang}}">
                             ...
                             <div class="form-group">
                                ...
                                <select name="kategori_id" class="form-control">
                                    <option value="">{{$inventaris->kategori->kategori_name}}</option>
                                    @foreach ($kategori as $row)
                                    <option value="{{ $row->id }}" {{ old('kategori_id') == $row->id ? 'selected':'' }}>{{ $row->kategori_name }}</option>
                                    @endforeach
                                </select>
                         ...
                         <div class="form-group">
                                 ...
                                 <input type="date" name="tanggal_pengadaan" class="form-control" placeholder="tanggal_pengadaan" value="{{$inventaris->tanggal_pengadaan}}">
                             ...
                             <div class="form-group">
                                ...
                                <select class="form-control" aria-label="Default select example" name="kondisi" >
                                    <option selected>>> {{$inventaris->kondisi}}<<</option>
                                    <option value="Layak">Layak</option>
                                    <option value="Tidak Layak">Tidak Layak</option>
                                    <option value="Harus diperbaiki">Harus diperbaiki</option>
                         ...
                         <div class="form-group">
                                 ...
                                 <input type="number" name="stok" class="form-control" placeholder="Jumlah" value="{{$inventaris->stok}}" >
                                 @if($errors->has('stok'))
                                     <div class="text-danger">
                                         {{ $errors->first('stok')}}
                                     </div>
